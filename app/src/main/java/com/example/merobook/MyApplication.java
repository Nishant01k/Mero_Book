...
import static com.example.merobook.Constants.MAX_BYTES_PDF;
...
public class MyApplication extends Application {
    ...
    public static void loadPdfFromUrlSinglePage(String pdfUrl, String pdfTitle, PDFView pdfView, SpinKitView progressBar, TextView pagesTv) {
        //using url we can get file and its metadata from firebase storage
